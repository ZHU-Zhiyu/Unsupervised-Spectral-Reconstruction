...
class Feature_extractor(nn.Module):
    def __init__(self,cin=31,cout=64):
        ...
        # self.spectraldown = denselayer1(cin = 1, cout= 4, RELU=True,kernel_size= 3,stride=2,BN=True)
        self.edenseconv = nn.Sequential(
            denselayer(cin = ecin, cout= ecout, RELU=True,kernel_size= 3,stride=1,BN=True,act=False),
            denselayer(cin = ecin + ecout*1, cout= ecout, RELU=True,kernel_size= 3,stride=1,BN=True,act=False),
            denselayer(cin = ecin + ecout*2, cout= ecout, RELU=True,kernel_size= 3,stride=1,BN=True,act=False),
            denselayer(cin = ecin + ecout*3, cout= ecout, RELU=True,kernel_size= 3,stride=1,BN=True,act=False),
        )
        self.adenseconv = denselayer(cin = cin-31, cout= ecout, RELU=True,kernel_size= 3,stride=1,BN=True,act=False)
        self.fianl_denseconv = nn.Sequential(
            denselayer(cin = ecout*1 + cout*1, cout= cout, RELU=True,kernel_size= 3,stride=1,BN=True,act=False),
            denselayer(cin = ecout*1 + cout*2, cout= cout, RELU=True,kernel_size= 3,stride=1,BN=True,act=False),
            denselayer(cin = ecout*1 + cout*3, cout= cout, RELU=True,kernel_size= 3,stride=1,BN=True,act=False),
            denselayer(cin = ecout*1 + cout*4, cout= cout, RELU=False,kernel_size= 3,stride=1,BN=False,act=False),
        )
