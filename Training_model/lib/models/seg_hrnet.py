...
class Network(nn.Module):
    def __init__(self, criterion, cfg, **kwargs):
        ...
        self.HRNet.init_weights('/home/zzy/disk1/HSIGAN/ICVL_Pascal/pixel_refine/pretrain/hrnet_w48_pascal_context_cls59_480x480.pth')
        ...
        self.dis_optimizer = torch.optim.Adam(itertools.chain(self.dishsi.parameters()),lr=5e-4)
